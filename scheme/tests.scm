...
(define make_even (lambda (x) (if (= (modulo x 2) 0) (x) (+ x 1)))) (make_even 3)
; expect 4

(define pi 3.14)
; expect pi

(define another_pi (eval(define pi 3.14)))
; expect another_pi

another_pi
; expect 3.14

(define (divide_by_three x) (/ x 3)) (divide_by_three 30)
; expect 10

;#7B

'(one (1 two . (3 . 5)))
; expect (one (1 two 3 . 5))

(cdr (quote (x y z . a)))
;expect (y z . a)

'(this is the last project!!!!) 
;expect (this is the last project!!!!) 

;#8
(begin (display 'project) (/ (+ 9 3) 3))
; expect project4
...
(let ((y 10)(z y)) (list x y z))
;expect (ex 10 why)

(define kinda (mu (v) (* v 10)))
;expect kinda
(define tired (lambda (y) (kinda y)))
;expect tired
(tired 5)
;expect 50
...
(define (some_pokemon x) 
  (cond
    ((= 4 0) 'pikachu)
    ((= (modulo 2 1) 0) 'charizard)
    (else 'jinx)
    )
  )
;expect some_pokemon
